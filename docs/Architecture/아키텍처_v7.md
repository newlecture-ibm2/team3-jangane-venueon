...
graph TB
    ...
    subgraph Backend["⚙️ Spring Boot Application :8080"]
        ...
        EM["event 모듈<br/>이벤트/세션 관리<br/>상태 Computed+강제"]
...
| **com.venueon.host.event** | 호스트 이벤트/세션 CUD, 상태 변경, **세션 강제 상태 관리** |
...
| **com.venueon.admin.*** | 관리자 회원 정지/권한, 공지 CUD, 카테고리 CUD |
