...
public class DataInitializer implements ApplicationRunner {
        ...
        public void run(ApplicationArguments args) {
                ...
                log.info("Category: {}개, Event: {}개, Session: {}개", categories.size(), events.size(),
                                eventSessionRepository.count());
        ...
        private List<UserJpaEntity> createHosts() {
                ...
                List<HostData> hostDataList = List.of(
                                ...
                                new HostData("forum@seoulscience.org", "SeoulScienceForum", "seoul-science-forum.png",
                                                "02-0123-4567",
        ...
        private List<EventJpaEntity> createEvents(List<UserJpaEntity> hosts, List<CategoryJpaEntity> categories) {
                return eventRepository.saveAll(List.of(
                                ...
                                EventJpaEntity.builder()
                                                ...
                                                .startDate(LocalDateTime.of(2026, 4, 1, 11, 0))
                                                .endDate(LocalDateTime.of(2026, 4, 30, 15, 0))
                                                .build(),
                                EventJpaEntity.builder()
                                                .creator(hosts.get(7))
                                ...
                                EventJpaEntity.builder()
                                                ...
                                                .endDate(LocalDateTime.of(2026, 2, 2, 18, 0))
                                                .build()));
        }

        /**
         * 세션 생성 — 모든 이벤트에 기본 세션(is_default=true) 생성
         * AI Bootcamp(index 0)와 Future Science Conference(index 9)는 hasSession=true로 다중
         * 세션 예시
         */
        ...
        private List<OrderJpaEntity> createOrders(List<UserJpaEntity> users, List<EventJpaEntity> events) {
                ...
                for (int i = 0; i < events.size(); i++) {
                        ...
                        // 환불(Refund) 데이터 연동을 위해 특정 이벤트는 CANCELLED로 설정 (Event Index 5: Business Growth
                        // Summit)
                        if (i == 5) {
